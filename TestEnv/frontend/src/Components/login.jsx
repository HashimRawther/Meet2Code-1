...
const Login=()=>{
    ...
    <div>
        ...
        <a className="mainPageRight d-flex align-items-center ustify-content-around flex-row"  rel="noreferrer" href="https://github.com/exploring-curiosity/Meet2Code" target="_blank">

...
const Login=()=>{
    ...
    <div>
        ...
        <a className="mainPageRight d-flex align-items-center justify-content-around flex-row"  rel="noreferrer" href="https://github.com/exploring-curiosity/Meet2Code" target="_blank">
